...
$(function () {
	...
	load_training(grid, '/RNN/training');
    ...
    $("#help").dxButton({
        ...
        onClick: function() {
			...
			result += "    'params' consists of at least 4 integers splitted by ';'.\n"
			result += "              the first integer could be an integer between 16 and 32 and\n"
			result += "              the middle integers should be an integer such as 32, 64, 128, etc and\n"
			result += "              the last integer should be a 20.\n"
			result += "              ex: 20;32;64;128;20, 20;32;64;128;128;20, etc.\n"
    ...
    $("#load_default_values").dxButton({
        ...
        type: "default",
        onClick: function() {
			parameters.option("value", "20;32;64;128;128;20, 200, 64, 0.1")
        }
    });
    ...
    var parameters = $("#parameters").dxTextBox({
        placeholder: "Ex: 20;32;64;128;128;20, 200, 64, 0.1",
        width: 260,
    }).dxTextBox("instance");
						...
						onClick: function(e) {
							...
							$.ajax({
								...
								success: function (result) {
									...
									load_training(grid1, '/RNN/trained');
								}
							});
						},
					},
