...
$(function () {
	...
	load_training(grid, '/FFNN/training');
    ...
    $("#help").dxButton({
        ...
        onClick: function() {
			...
			result += "    [neurons], [epochs], [batch_size], [validation_split]\nHere\n"
			result += "    'neurons' consists of several integers splitted by ';'.\n"
			result += "              the first integer should be a multiple of 20 and\n"
			result += "              the last integer should be a 20.\n"
			result += "              ex: 80;64;32;16;20, 80;64;48;32;16;20, etc.\n"
    ...
    $("#load_default_values").dxButton({
        ...
        type: "default",
        onClick: function() {
			parameters.option("value", "80;64;32;16;20, 2000, 64, 0.1")
        }
    });
    ...
    var parameters = $("#parameters").dxTextBox({
        placeholder: "Ex: 80;64;32;16;20, 2000, 64, 0.1",
        width: 220,
    }).dxTextBox("instance");
            ...
            columns: [
                ...
                },
                {
					...
					},
					{
						...
						visible: true,
						onClick: function(e) {
							parameters.option("value", e.row.data.model.split('-')[1] + ", 2000, 64, 0.1")
							$.ajax({
								url: "/FFNN/trained",
								type: "DELETE",
								...
								success: function (result) {
									...
									load_training(grid1, '/FFNN/trained');
								}
							});
						},
					},
